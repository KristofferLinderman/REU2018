...
xo = []
yo = []
for line in open("data/testsubject-1/timedata.txt"):
	arr = line.split()
	if(len(arr)>0):
...
x1=[]
y1=[]
for line in open("data/testsubject-1/heartdata.txt"):
	arr = line.split()
	if(len(arr)>0):
		currentx = float(arr[0])
...
x2=[]
y2=[]
for line in open("data/testsubject-1/smiledata.txt"):
	arr = line.split()
	if(len(arr)>0):
		currentx = float(arr[0])
...
x3=[]
y3=[]
for line in open("data/testsubject-1/eyedata.txt"):
	arr = line.split()
	if(len(arr)>0):
		currentx = float(arr[0])
		currenty = float(arr[1])/100
...
def smooth_demo():
    ...
    x=sin(t)
    xn=x+numpy.random.rand(len(t))*0.1
